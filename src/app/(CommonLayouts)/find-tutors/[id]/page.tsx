    ...
    return (
      <div className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="mt-4 text-gray-500 dark:text-gray-400">
          Please check the link or go back to the Find Tutors page.
        </p>
      </div>
    );
  }
      ...
      <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12 bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg">
        ...
        <div className="flex-1 space-y-2">
          ...
          <div className="flex flex-wrap gap-4 mt-2">
            <span className="bg-indigo-100 dark:bg-indigo-800 text-indigo-800 dark:text-indigo-100 px-3 py-1 rounded-full font-medium">
              💰 ${tutor.pricePerHour}/hr
            </span>
            <span className="bg-green-100 dark:bg-green-800 text-green-800 dark:text-green-100 px-3 py-1 rounded-full font-medium">
